...
void main() {
  group('Data Layer - upacharaachamaneya content', () {
    test('upacharaachamaneya has correct block count and types', () {
      final file = File('assets/i18n/kn/components/upacharaachamaneya.json');
      final component = Component.fromJson(jsonDecode(file.readAsStringSync()));
      expect(component.id, 'upacharaachamaneya');

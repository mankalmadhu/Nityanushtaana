...
void main() {
  group('Data Layer - aasana content', () {
    test('aasana has correct block count and types', () {
      final file = File('assets/i18n/kn/components/aasana.json');
      final component = Component.fromJson(jsonDecode(file.readAsStringSync()));
      expect(component.id, 'aasana');
      expect(component.blocks.length, 3);
      expect(component.blocks[0].type, 'heading');
      expect(component.blocks[0].text, 'ಆಸನ');

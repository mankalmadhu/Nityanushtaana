...
void main() {
  group('Data Layer - kalashaarchane content', () {
    test('kalashaarchane has correct block count and types', () {
      final file = File('assets/i18n/kn/components/kalashaarchane.json');
      final component = Component.fromJson(jsonDecode(file.readAsStringSync()));
      expect(component.id, 'kalashaarchane');
      expect(component.blocks.length, 9);
      expect(component.blocks[0].type, 'heading');
      expect(component.blocks[0].text, 'ಕಲಶಾರ್ಚನೆ');

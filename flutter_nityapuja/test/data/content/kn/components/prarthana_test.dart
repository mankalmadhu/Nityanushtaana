...
void main() {
  group('Data Layer - prarthana content', () {
    test('prarthana has correct block count and types', () {
      final file = File('assets/i18n/kn/components/prarthana.json');
      final component = Component.fromJson(jsonDecode(file.readAsStringSync()));
      expect(component.id, 'prarthana');
      expect(component.blocks.length, 3);
      expect(component.blocks[0].type, 'heading');
      expect(component.blocks[0].text, 'ಪ್ರಾರ್ಥನ');

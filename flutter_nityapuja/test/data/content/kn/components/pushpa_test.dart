...
void main() {
  group('Data Layer - pushpa content', () {
    test('pushpa has correct block count and types', () {
      final file = File('assets/i18n/kn/components/pushpa.json');
      final component = Component.fromJson(jsonDecode(file.readAsStringSync()));
      expect(component.id, 'pushpa');
      expect(component.blocks.length, 3);
      expect(component.blocks[0].type, 'heading');
      expect(component.blocks[0].text, 'ಪುಷ್ಪ');

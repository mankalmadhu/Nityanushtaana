...
void main() {
  group('Data Layer - namaskara content', () {
    test('namaskara has correct block count and types', () {
      final file = File('assets/i18n/kn/components/namaskara.json');
      final component = Component.fromJson(jsonDecode(file.readAsStringSync()));
      expect(component.id, 'namaskara');
      expect(component.blocks.length, 3);
      expect(component.blocks[0].type, 'heading');
      expect(component.blocks[0].text, 'ಪ್ರದಕ್ಷಿಣ ನಮಸ್ಕಾರ');

...
void main() {
  group('Data Layer - dhupa content', () {
    test('dhupa has correct block count and types', () {
      final file = File('assets/i18n/kn/components/dhupa.json');
      final component = Component.fromJson(jsonDecode(file.readAsStringSync()));
      expect(component.id, 'dhupa');
      expect(component.blocks.length, 4);
      expect(component.blocks[0].type, 'heading');
      expect(component.blocks[0].text, 'ಧೂಪ');

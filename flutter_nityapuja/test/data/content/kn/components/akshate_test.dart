...
void main() {
  group('Data Layer - akshate content', () {
    test('akshate has correct block count and types', () {
      final file = File('assets/i18n/kn/components/akshate.json');
      final component = Component.fromJson(jsonDecode(file.readAsStringSync()));
      expect(component.id, 'akshate');
      expect(component.blocks.length, 3);
      expect(component.blocks[0].type, 'heading');
      expect(component.blocks[0].text, 'ಅಕ್ಷತೆ');

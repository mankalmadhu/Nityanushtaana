...
void main() {
  group('Data Layer - upaveta content', () {
    test('upaveta has correct block count and types', () {
      final file = File('assets/i18n/kn/components/upaveta.json');
      final component = Component.fromJson(jsonDecode(file.readAsStringSync()));
      expect(component.id, 'upaveta');
      expect(component.blocks.length, 3);
      expect(component.blocks[0].type, 'heading');
      expect(component.blocks[0].text, 'ಉಪವೀತ');

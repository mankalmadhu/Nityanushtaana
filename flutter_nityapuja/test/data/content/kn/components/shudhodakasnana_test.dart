...
void main() {
  group('Data Layer - shudhodakasnana content', () {
    test('shudhodakasnana has correct block count and types', () {
      final file = File('assets/i18n/kn/components/shudhodakasnana.json');
      final component = Component.fromJson(jsonDecode(file.readAsStringSync()));
      expect(component.id, 'shudhodakasnana');
      expect(component.blocks.length, 4);
      expect(component.blocks[0].type, 'heading');
      expect(component.blocks[0].text, 'ಶುದ್ಧೋದಕಸ್ನಾನ');

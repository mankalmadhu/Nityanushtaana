...
void main() {
  group('Data Layer - neerajana content', () {
    test('neerajana has correct block count and types', () {
      final file = File('assets/i18n/kn/components/neerajana.json');
      final component = Component.fromJson(jsonDecode(file.readAsStringSync()));
      expect(component.id, 'neerajana');
      expect(component.blocks.length, 7);
      expect(component.blocks[0].type, 'heading');
      expect(component.blocks[0].text, 'ನೀರಾಜನ');
      ...
      expect(component.blocks[5].type, 'vedic_instruction');

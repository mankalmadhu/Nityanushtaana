...
void main() {
  group('Data Layer - madhuparka content', () {
    test('madhuparka has correct block count and types', () {
      final file = File('assets/i18n/kn/components/madhuparka.json');
      final component = Component.fromJson(jsonDecode(file.readAsStringSync()));
      expect(component.id, 'madhuparka');
      expect(component.blocks.length, 3);
      expect(component.blocks[0].type, 'heading');
      expect(component.blocks[0].text, 'ಮಧುಪರ್ಕ');

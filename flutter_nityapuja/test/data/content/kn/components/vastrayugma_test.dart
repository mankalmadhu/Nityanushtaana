...
void main() {
  group('Data Layer - vastrayugma content', () {
    test('vastrayugma has correct block count and types', () {
      final file = File('assets/i18n/kn/components/vastrayugma.json');
      final component = Component.fromJson(jsonDecode(file.readAsStringSync()));
      expect(component.id, 'vastrayugma');
      expect(component.blocks.length, 3);
      expect(component.blocks[0].type, 'heading');
      expect(component.blocks[0].text, 'ವಸ್ತ್ರಯುಗ್ಮ');

...
import ಸಾಯ೦ಸಮಿಧಾದಾನಸ೦ಕಲ್ಪ from '../Ghatta/Sankalpa/SayamSamidhaDanaSankalpa';
...
import ಸಾಯ೦ಸಮಿಧಾದಾನಸಮರ್ಪಣ from '../Ghatta/Samarpana/SayamSamidhaDanaSamarpana';
import ಅಪರಾಧಕ್ಷಮಾಪಣ from '../Ghatta/AparadhaKshamapana/AparadhaKshamapana';

export default ಸಾಯ೦ಸಮಿಧಾದಾನ = () =>

     (
      <ಲೇಖನ>
        <ಪುಟ>
        <ವಿಷಯ ವಿನ್ಯಾಸ = {ಘಟ್ಟವಿನ್ಯಾಸ.ಶೀರ್ಷಿಕೆ}>
         (ಅಗ್ನಿಯನ್ನು ಪೂರ್ವ/ಉತ್ತರ ಅಭಿಮುಖವಾಗಿ ಇರಿಸಿಕೊ೦ಡು, ಅಗ್ನಿಗೆ ಅಭಿಮುಖವಾಗಿ ಕುಳಿತುಕೊಳ್ಳುವುದು)
        </ವಿಷಯ>
        <ಆಚಮನೀಯ />
        </ಪುಟ>
        <ಪುಟ>

...
class RitualRepository {
  ...
  Future<AppIndex> loadIndex(String languageCode) async {
    ...
    try {
      ...
      throw Exception('Failed to load index file from bundle: $path. Error: $e');
    }
  }
  ...
  Future<Ritual> loadRitual(String ritualId, String languageCode) async {
    ...
    try {
      ...
      throw Exception('Failed to load ritual file from bundle: $path. Error: $e');
    }
  }

  /// Loads a specific component by ID
  Future<Component> loadComponent(String componentId, String languageCode) async {
    ...
    try {
      ...
      throw Exception('Failed to load component file from bundle: $path. Error: $e');
    }
  }
}

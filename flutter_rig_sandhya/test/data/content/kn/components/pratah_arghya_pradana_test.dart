...
void main() {
  group('Data Layer - Kannada Content Sanitization', () {
    test('pratah_arghya_pradana content has not been accidentally modified', () {
      ...
      expect(component.blocks[6].text, 'ಕಾಲಾತೀತ ದೋಷ ಪ್ರಾಯಶ್ಚಿತ್ತಾರ್ಥ೦ ಅರ್ಘ್ಯ ಪ್ರದಾನ೦ ಕರಿಷ್ಯೇ ।');
      expect(component.blocks[7].type, 'verse_viniyoga');
      expect(component.blocks[7].text, 'ಓ೦ ತತ್ಸ॑ವಿ॒ತುರ್ವರೇ᳚ಣ್ಯ॒೦ ಭರ್ಗೋ᳚ ದೇ॒ವಸ್ಯ॑ ಧೀಮಹಿ । ಧಿಯೋ॒ ಯೋ ನಃ॑ ಪ್ರಚೋ॒ದಯಾ᳚ತ್ ॥');
      expect(component.blocks[8].type, 'verse_viniyoga');
      expect(component.blocks[8].text, 'ಓ॒ಮಾಪೋ॒ ಜ್ಯೋತೀ॒ರಸೋ॒ಽಮೃತ॒೦ ಬ್ರಹ್ಮ॒ ಭೂರ್ಭುವ॒ಸ್ಸ್ವರೋ೦॥');
      expect(component.blocks[9].type, 'verse_viniyoga');
      expect(component.blocks[9].text, 'ಓ೦ ಯದ॒ದ್ಯ ಕಚ್ಚ॑ ವೃತ್ರಹನ್ನು॒ದಗಾ᳚ ಅ॒ಭಿ ಸೂ᳚ರ್ಯ । ಸರ್ವ॒೦ ತದಿ᳚೦ದ್ರ ತೇ॒ ವಶೇ᳚ ॥\nಸೂರ್ಯ ಅಹ೦ ಸೂರ್ಯಃ । ಅಸಾವಾದಿತ್ಯೋ ಬ್ರಹ್ಮ ॥');
    });
  });
}

...
void main() {
  group('Data Layer - Kannada Content Sanitization', () {
    test('sayam_upasthana content has not been accidentally modified', () {
      final file = File('assets/i18n/kn/components/sayam_upasthana.json');
      ...
      expect(component.blocks[2].text, 'ಜಾತವೇದಸಮಿತಿ ಕಶ್ಯಪೋಜಾತವೇದಾಗ್ನಿಸ್ತ್ರಿಷ್ಟುಪ್ , ಉಪಸ್ಥಾನೇ ವಿನಿಯೋಗಃ ।');
      expect(component.blocks[3].type, 'verse_viniyoga');
      expect(component.blocks[3].text, 'ಓ೦ ಜಾ॒ತವೇ᳚ದಸೇ ಸುನವಾಮ॒ ಸೋಮ॑ಮರಾತೀ ಯ॒ತೋ ನಿ ದ॑ಹಾತಿ॒ ವೇದಃ॑ ।\nಸ ನಃ॑ ಪರ್ಷ॒ದತಿ॑ ದು॒ರ್ಗಾಣಿ॒ ವಿಶ್ವಾ᳚ ನಾ॒ವೇವ॒ ಸಿ೦ಧು᳚೦ ದುರಿ॒ತಾತ್ಯ॒ಗ್ನಿಃ ॥ಓ೦ ಶಾ೦ತಿ॒ಶ್ಯಾ೦ತಿ॒ಶ್ಯಾ೦ತಿಃ॑ ।');
      expect(component.blocks[4].type, 'verse_sankalpa');
      expect(component.blocks[4].text, 'ತಚ್ಛ೦ಯೋರಿತಿ ಸಾರಸ್ವತೋಗ್ನಿಸ್ತ್ರಿಷ್ಟುಪ್ ಉಪಸ್ಥಾನೇ ವಿನಿಯೋಗಃ।');
      expect(component.blocks[5].type, 'verse_viniyoga');
      expect(component.blocks[5].text, 'ಓ೦ ತಚ್ಛ॒೦ ಯೋರಾವೃ॑ಣೀಮಹೇ । ಗಾ॒ತು೦ ಯ॒ಜ್ಞಾಯ॑ ಗಾ॒ತು೦ ಯ॒ಜ್ಞ್ನಪ॑ತಯೇ ।\nದೈವೀಃ᳚ ಸ್ವ॒ಸ್ತಿರ॑ಸ್ತು ನಃ। ಸ್ವ॒ಸ್ತಿರ್ಮಾನು॑ಷೇಭ್ಯಃ । ಊ॒ರ್ಧ್ವ೦ ಜಿ॑ಗಾತು ಭೇಷ॒ಜ೦ ।\nಶ೦ ನೋ॑ ಅಸ್ತು ದ್ವಿ॒ಪದೇ᳚ ಶ೦ ಚತು॑ಷ್ಪದೇ ॥ಓ೦ ಶಾ೦ತಿ॒ಶ್ಯಾ೦ತಿ॒ಶ್ಯಾ೦ತಿಃ॑ ।');
      expect(component.blocks[6].type, 'verse_sankalpa');
      expect(component.blocks[6].text, 'ನಮೋ ಬ್ರಹ್ಮಣೇ ಪ್ರಜಾಪತಿರ್ವಿಶ್ವೇದೇವಾ ಜಗತಿ ಉಪಸ್ಥಾನೇ ವಿನಿಯೋಗಃ ।');
      expect(component.blocks[7].type, 'verse_viniyoga');
      expect(component.blocks[7].text, 'ಓ೦ ನಮೋ॒ ಬ್ರ॒ಹ್ಮಣೇ॒ ನಮೋ᳚ ಅಸ್ತ್ವ॒ಗ್ನಯೇ॒ ನಮಃ॑ ಪೃಥಿ॒ವ್ಯೈ ನಮ॒ ಓಷ॑ಧೀಭ್ಯಃ । ನಮೋ᳚ ವಾ॒ಚೇ ನಮೋ᳚ ವಾ॒ಚಸ್ಪ॑ತಯೇ॒ ನಮೋ॒ ವಿಷ್ಣ॑ವೇ ಮಹ॒ತೇ ಕ॑ರೋಮೀ ॥');

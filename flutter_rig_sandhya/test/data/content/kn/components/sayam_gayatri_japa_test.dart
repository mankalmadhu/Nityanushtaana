...
void main() {
  group('Data Layer - Kannada Content Sanitization', () {
    test('sayam_gayatri_japa content has not been accidentally modified', () {
      final file = File('assets/i18n/kn/components/sayam_gayatri_japa.json');
      ...
      expect(
        ...
        'ಆಗಚ್ಛ ವರದೇ ದೇವೀ ಜಪ್ಯೇಮೇ ಸನ್ನಿಧೌ ಭವ । ಗಾಯಂತಂ ತ್ರಾಯಸೇ ಯಸ್ಮಾತ್ ಗಾಯತ್ರೀಂ ತ್ವಮತಸ್ಮೃತ ।\nಗಾಯತ್ರಿಯಾ ಗಾಥಿನೋ ವಿಶ್ವಾಮಿತ್ರ ಋಷಿಃ, ಸವಿತಾ ದೇವತಾ, ಗಾಯತ್ರೀ ಛಂದಃ।\nಅರ್ಗ್ನಿಮುಖಂ, ಬ್ರಹ್ಮಾ ಶಿರಃ, ವಿಷ್ಣುರ್ಹೃದಯಂ, ರುದ್ರಃಶಿಖಾ, ಪೃಥ್ವೀಯೋನಿ, ಪ್ರಾಣಾಪಾನ, ವ್ಯಾನೋದಾನ,\nಸ ಮಾನಾ ಸ ಪ್ರಾಣಾ, ಶ್ವೇತ ವರ್ಣಾ, ಸಾಂಖ್ಯಾಯನಸ ಗೋತ್ರಾ, ಗಾಯತ್ರೀ ಚತುರ್ವಿಂಶತ್ಯಕ್ಷರಾ ,\nತ್ರಿಪದಾ ಷಟ್ಕುಕ್ಷಿಃ, ಪಂಚಶೀರ್ಷೋಪನಯನೇ ವಿನಿಯೋಗಃ ।',
      );
      expect(component.blocks[2].type, 'heading');
      expect(component.blocks[2].text, 'ಗಾಯತ್ರೀ ಜಪ ಸಂಕಲ್ಪ');
      ...
      expect(
        ...
        'ಮಮ ಉಪಾತ್ತ ಸಮಸ್ತ ದುರಿತಕ್ಷಯದ್ವಾರಾ ಶ್ರೀ ಪರಮೇಶ್ವರ ಪ್ರೀತ್ಯರ್ಥಂ ಸಾಯಂ ಸಂಧ್ಯಾಂಗ ಯಥಾ ಶಕ್ತಿ ಗಾಯತ್ರೀ ಮಹಾಮಂತ್ರ ಜಪಂ ಕರಿಷ್ಯೇ ॥',
      );
      ...
      expect(
        ...
        'ತತ್ಸವಿತುಃ ಅಂಗುಷ್ಠಾಭ್ಯಾಂ ನಮಃ । ವರೇಣ್ಯಂ ತರ್ಜನೀಭ್ಯಾಂ ನಮಃ ।\nಭರ್ಗೋದೇವಸ್ಯ ಮಧ್ಯಮಾಭ್ಯಾಂ ನಮಃ ।ಧೀಮಹಿ ಅನಾಮಿಕಾಭ್ಯಾಂ ನಮಃ ।\nಧಿಯೋಽಯೋನಃ ಕನಿಷ್ಠಿಕಾಭ್ಯಾಂ ನಮಃ ।ಪ್ರಚೋದಯಾತ್ ಕರತಲ ಕರಪೃಷ್ಠಾಭ್ಯಾಂ ನಮಃ ।',
      );
      expect(component.blocks[10].type, 'heading');
      expect(component.blocks[10].text, 'ಅಂಗನ್ಯಾಸ');
      expect(component.blocks[11].type, 'verse_viniyoga');
      expect(
        component.blocks[11].text,
        'ತತ್ಸವಿತುಃ ಹೃದಯಾಯ ನಮಃ । ವರೇಣ್ಯಂ ಶಿರಸೇ ಸ್ವಾಹಾ ।\nಭರ್ಗೋದೇವಸ್ಯ ಶಿಖಾಯೈ ವಷಟ್ ।ಧೀಮಹಿ ಕವಚಾಯಹುಂ ।\nಧಿಯೋಽಯೋನಃ ನೇತ್ರತ್ರಯಾಯ ವೌಷಟ್ ।ಪ್ರಚೋದಯಾತ್ ಅಸ್ತ್ರಾಯಫಟ್ ।',
      );
      expect(component.blocks[12].type, 'verse_viniyoga');
      expect(
        component.blocks[12].text,
        'ಭೂರ್ಭುವಸ್ಸ್ವರೋಮಿತಿ ದಿಗ್ಬಂಧಃ । ಧ್ಯಾನಂ ।।',
      );
      expect(component.blocks[13].type, 'heading');
      expect(component.blocks[13].text, 'ಸಾಯಂಸ್ವರೂಪ');
      expect(component.blocks[14].type, 'verse_viniyoga');
      expect(
        component.blocks[14].text,
        'ಅಥ ತಾಂ ಸಾಯಂ ವೃದ್ಧಾಂ । ವೃದ್ಧಾದಿತ್ಯ ಮಂಡಲ ಮಧ್ಯಸ್ಥಾಂ ।\nಶ್ಯಾಮ ವರ್ಣಾಂ ಶ್ಯಾಮಾಂಬರಾನು ಲೇಪನ ಸ್ರಗಾಭರಣಾಂ ।\nಏಕವಕ್ತ್ರಾಂ ಶಂಖ ಚಕ್ರ ಗದಾ ಪದ್ಮಾಂಕ ಚತುರ್ಭುಜಾಂ ।\nಗರುಡಾಸನಾ ರೂಢಾಂ ವಿಷ್ಣು ದೈವತ್ಯಾಂ ।\nಸಾಮವೇದಮುದಾಹರಂತೀಂ ಸುವರ್ಲೋಕಾಧಿಷ್ಠಾತ್ರೀಂ ।\nಸರಸ್ವತೀಂ ನಾಮ ದೇವತಾಂ ಧ್ಯಾಯೇತ್ ।',
      );
      expect(component.blocks[15].type, 'heading');
      expect(component.blocks[15].text, 'ಮಂತ್ರಾರ್ಥ');
      expect(component.blocks[16].type, 'verse_viniyoga');
      expect(
        component.blocks[16].text,
        'ಯೊ ದೇವಃ ಸವಿತಾಸ್ಮಾಕಂ । ಧಿಯೋ ಧರ್ಮಾದಿ ಗೋಚರಃ । ಪ್ರೇರಯೇತ್ ತಸ್ಯ ಯದ್ಭರ್ಗಃ ।\nತದ್ವರೇಣ್ಯಂ ಉಪಾಸ್ಮಹೇ । ಸವಿತುರ್ದೇವಸ್ಯ ವರೇಣ್ಯಂ । ತೇಜೋ ಧ್ಯಾಯೇಮಹಿ ।\nಯೋಽಸ್ಮಾಕಂ ಕರ್ಮಾಣಿ । ಪ್ರೇರಯೇತ್ ಇತಿ ಮಂತ್ರಾರ್ಥಃ ।',
      );
      ...
      expect(component.blocks[23].text, 'ಅಂಗನ್ಯಾಸ');
      ...
      expect(
        ...
        'ಭೂರ್ಭುವಸ್ಸ್ವರೋಮಿತಿ ದಿಗ್ವಿಮೋಕಃ । ಧ್ಯಾನಂ ।।',
      );
      ...
      expect(
        ...
        'ಮುಕ್ತಾವಿದ್ರುಮ ಹೇಮ ನೀಲ ಧವಳಚ್ಛಾಯೈಃ ಮುಖೈಸ್ತ್ರೈಕ್ಷಣೈಃ ಯುಕ್ತಾಮಿಂದುನಿಬದ್ಧ ರತ್ನ ಮಕುಟಾಂ ತತ್ವಾರ್ಥ ವರ್ಣಾತ್ಮಿಕಾಂ ।\nಗಾಯತ್ರೀಂ ವರದಾಭಯಾಂ ಅಂಕುಶಕಶಾಃ ಶುಭ್ರಂ ಕಪಾಲಂ ಗದಾಂ ಶಂಖಂ ಚಕ್ರಮಥಾರವಿಂದ ಯುಗಳಂ ಹಸ್ತೈರ್ವಹಂತೀಂ ಭಜೇ ।',
      );
    });
  });
}

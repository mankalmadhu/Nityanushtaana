  ...
  group('Data Layer - Kannada Content Sanitization', () {
    test('sayam_gayatri_japa content has not been accidentally modified', () {
      ...
      expect(
        ...
        'ಮಮ ಉಪಾತ್ತ ಸಮಸ್ತ ದುರಿತಕ್ಷಯದ್ವಾರಾ ಶ್ರೀ ಪರಮೇಶ್ವರ ಪ್ರೀತ್ಯರ್ಥ೦ ಸಾಯ೦ ಸ೦ಧ್ಯಾ೦ಗ ಯಥಾ ಶಕ್ತಿ ಗಾಯತ್ರೀ ಮಹಾಮ೦ತ್ರ ಜಪ೦ ಕರಿಷ್ಯೇ ॥',
      );
      ...
      expect(component.blocks[13].text, 'ಸಾಯ೦ಸ್ವರೂಪ');

  ...
  group('Data Layer - Kannada Content Sanitization', () {
    test('sayam_marjane content has not been accidentally modified', () {
      ...
      expect(
        ...
        'ಅಗ್ನಿಶ್ಚೇತ್ಯಸ್ಯ ಮಂತ್ರಸ್ಯ ಅಗ್ನಿಮಾ ಮನ್ಯುಃ ಮನ್ಯುಪತಯಃ ರಾತ್ರಿರ್ದೇವತಾ ಪ್ರಕೃತಿಪುರುಷಂ ಛಂದ: ಜಲಾಭಿಮಂತ್ರಣೇ ವಿನಿಯೋಗಃ ॥',
      );
      expect(component.blocks[5].type, 'verse_viniyoga');
      expect(
        component.blocks[5].text,
        'ಅಗ್ನಿಶ್ಚ ಮಾ ಮನ್ಯುಶ್ಚ ಮನ್ಯುಪತಯಶ್ಚ ಮನ್ಯು॑ಕೃತೇ॒ಭ್ಯಃ । ಪಾಪೇಭ್ಯೋ॑ ರಕ್ಷಂ॒ತಾಮ್ ।\nಯದ್ರಾತ್ರ್ಯಾ ಪಾಪ॑ಮಕಾ॒ರ್ಷಮ್ । ಮನಸಾ ವಾಚಾ॑ ಹಸ್ತಾ॒ಭ್ಯಾಂ । ಪದ್ಭ್ಯಾಂ ಉದರೇ॑ಣ ಶಿ॒ಶ್ಞಾ ।\nರಾತ್ರಿ॒ಸ್ತದ॑ವಲುಂ॒ಪತು । ಯತ್ಕಿಂಚ॑ ದುರಿ॒ತಂ ಮಯಿ॑ ।\nಇದಮಹಂ ಮಾಮಮೃ॑ತಯೋ॒ನೌ । ಸತ್ಯೇ ಜ್ಯೋತಿಷಿ ಜುಹೋ॑ಮಿ ಸ್ವಾ॒ಹಾ ॥',
      );
    });
  });
}

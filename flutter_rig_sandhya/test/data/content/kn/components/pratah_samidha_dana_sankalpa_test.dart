...
void main() {
  group('Data Layer - Kannada Content Sanitization', () {
    test(
      'pratah_samidha_dana_sankalpa content has not been accidentally modified',
      () {
        final file = File(
          'assets/i18n/kn/components/pratah_samidha_dana_sankalpa.json',
        );
        ...
        expect(
          ...
          'ಮಮ ಉಪಾತ್ತ ಸಮಸ್ತ ದುರಿತಕ್ಷಯದ್ವಾರಾ ಶ್ರೀ ಪರಮೇಶ್ವರ ಪ್ರೀತ್ಯರ್ಥ೦ ಪ್ರಾತಸ್ಸಮಿಧಾದಾನ೦ ಕರಿಷ್ಯೇ ॥',
        );
      },
    );
  });

...
void main() {
  group('Data Layer - Kannada Content Sanitization', () {
    test(
      'sayam_samidha_dana_samarpana content has not been accidentally modified',
      () {
        final file = File(
          'assets/i18n/kn/components/sayam_samidha_dana_samarpana.json',
        );
        ...
        expect(
          ...
          'ಅನೇನ ಸಾಯ೦ ಸಮಿಧಾದಾನೇನ ಭಗವಾನ್ ಸರ್ವಾತ್ಮಕಃ ಶ್ರೀ ತೇಜೋ ಲಕ್ಷ್ಮೀನೃಸಿ೦ಹ ಸ್ವಾಮಿನಃ ಪ್ರೀಣಾತು ।',
        );
      },
    );
  });

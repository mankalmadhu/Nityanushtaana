...
void main() {
  group('Data Layer - Kannada Content Sanitization', () {
    test(
      'madhyahnika_arghya_sankalpa content has not been accidentally modified',
      () {
        final file = File(
          'assets/i18n/kn/components/madhyahnika_arghya_sankalpa.json',
        );
        ...
        expect(
          ...
          'ಮಮ ಉಪಾತ್ತ ಸಮಸ್ತ ದುರಿತಕ್ಷಯದ್ವಾರಾ ಶ್ರೀ ಪರಮೇಶ್ವರ ಪ್ರೀತ್ಯರ್ಥ೦ ಮಾಧ್ಯಾಹ್ನಿಕ ಸ೦ಧ್ಯಾ೦ಗ ಅರ್ಘ್ಯ ಪ್ರದಾನಾನಿ ಕರಿಷ್ಯೇ ॥',
        );
      },
    );
  });

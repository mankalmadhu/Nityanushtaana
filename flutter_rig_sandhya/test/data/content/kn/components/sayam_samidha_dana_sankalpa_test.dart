...
void main() {
  group('Data Layer - Kannada Content Sanitization', () {
    test(
      'sayam_samidha_dana_sankalpa content has not been accidentally modified',
      () {
        final file = File(
          'assets/i18n/kn/components/sayam_samidha_dana_sankalpa.json',
        );
        ...
        expect(component.blocks[0].text, 'ಸಾಯಂ ಸಮಿಧಾದಾನ ಸಂಕಲ್ಪ');
        ...
        expect(
          ...
          'ಮಮ ಉಪಾತ್ತ ಸಮಸ್ತ ದುರಿತಕ್ಷಯದ್ವಾರಾ ಶ್ರೀ ಪರಮೇಶ್ವರ ಪ್ರೀತ್ಯರ್ಥಂ ಸಾಯಂ ಸಮಿಧಾದಾನಂ ಕರಿಷ್ಯೇ ॥',
        );
      },
    );
  });

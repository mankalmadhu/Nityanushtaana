  ...
  group('Data Layer - Kannada Content Sanitization', () {
    test('madhyahnika_arghya_pradana content has not been accidentally modified', () {
      ...
      expect(
        ...
        'ಹಂಸಃ ಶುಚಿಷತ್ ಇತಿ, ಏಕಸ್ಯ ಋಚೋ, ಗೌತಮ ಪುತ್ರೋ ವಾಮದೇವ ಋಷಿಃ, ಸೂರ್ಯೋ ದೇವತಾ ಜಗತೀಛಂದಃ ಅರ್ಘ್ಯ ಪ್ರದಾನೇ ವಿನಿಯೋಗಃ ।',
      );
      expect(component.blocks[3].type, 'verse_viniyoga');
      expect(
        component.blocks[3].text,
        'ಓಂ ಹಂ॒ಸಃ ಶು॑ಚಿ॒ಷದ್ವಸು॑ರಂತರಿಕ್ಷ॒ ಸದ್ಧೋತಾ᳚ವೇದಿ॒ಷದತಿ॑ಥಿರ್ದುರೋಣ॒ಸತ್ । ನೃ॒ಷದ್ವ॑ರ॒ಸದೃ॑ತ॒ಸದ್ವ್ಯೋ᳚ಮ॒ಸದ॒ಬ್ಜಾ ಗೋ॒ಜಾ ಋ॑ತ॒ಜಾ ಅ॑ದ್ರಿ॒ಜಾ ಋ॒ತಮ್ ।',
      );
      ...
      expect(
        ...
        'ಆಕೃ॒ಷ್ಣೇನ॒ ರಜ॑ಸಾ॒ ವರ್ತ॑ಮಾನೋ ನಿವೇ॒ಶಯ॑ನ್ನ॒ಮೃತಂ॒ ಮರ್ತ್ಯಂ᳚ ಚ । ಹಿ॒ರ॒ಣ್ಯಯೇ᳚ನ ಸವಿ॒ತಾ ರಥೇ॒ನಾಽಽದೇ॒ವೋ ಯಾ᳚ತಿ॒ ಭುವ॑ನಾನಿ॒ಪಶ್ಯನ್॑ ।',
      );
      ...
      expect(
        ...
        'ಓಂ ಭೂರ್ಭುವ॒ಸ್ಸ್ವಃ । ಓಂ ತತ್ಸ॑ವಿ॒ತುರ್ವರೇ᳚ಣ್ಯಂ॒ ಭರ್ಗೋ᳚ ದೇ॒ವಸ್ಯ॑ ಧೀಮಹಿ । ಧಿಯೋ॒ ಯೋ ನಃ॑ ಪ್ರಚೋ॒ದಯಾ᳚ತ್ ॥\nಓ॒ಮಾಪೋ॒ ಜ್ಯೋತೀ॒ರಸೋ॒ಽಮೃತಂ॒ ಬ್ರಹ್ಮ॒ ಭೂರ್ಭುವ॒ಸ್ಸ್ವರೋಂ॥',
      );
      expect(component.blocks[10].type, 'verse_viniyoga');
      expect(
        component.blocks[10].text,
        'ಓಂ ಪ್ರಾ॒ತರ್ದೇ॒ವೀಮದಿ॑ತಿಂ ಜೋಹವೀಮಿ ಮ॒ಧ್ಯಂದಿ॑ನ॒ ಉದಿ॑ತಾ॒ ಸೂರ್ಯ॑ಸ್ಯ ।\nರಾ॒ಯೇ ಮಿ॑ತ್ರಾವರುಣಾ ಸ॒ರ್ವತಾ॒ತೇಳೇ᳚ ತೋ॒ಕಾಯ॒ ತನ॑ಯಾಯ॒ ಶಂಯೋಃ।ಅಸಾವಾದಿತ್ಯೋ ಬ್ರಹ್ಮ ।',
      );
    });
  });
}

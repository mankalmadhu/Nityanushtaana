...
void main() {
  group('Data Layer - Kannada Content Sanitization', () {
    test('pratah_sandhya_sankalpa content has not been accidentally modified', () {
      ...
      expect(component.blocks[0].text, 'ಪ್ರಾತಃ ಸ೦ಧ್ಯಾ ಸ೦ಕಲ್ಪ');
      ...
      expect(component.blocks[5].text, 'ಮಮ ಉಪಾತ್ತ ಸಮಸ್ತ ದುರಿತಕ್ಷಯದ್ವಾರಾ ಶ್ರೀ ಪರಮೇಶ್ವರ ಪ್ರೀತ್ಯರ್ಥ೦ ಪ್ರಾತಃ ಸ೦ಧ್ಯಾ೦ ಉಪಾಸ್ಯೇ ॥');
    });
  });
}

...
void main() {
  group('Data Layer - Kannada Content Sanitization', () {
    test('pratah_sandhya_sankalpa content has not been accidentally modified', () {
      final file = File(
        'assets/i18n/kn/components/pratah_sandhya_sankalpa.json',
      );
      final component = Component.fromJson(jsonDecode(file.readAsStringSync()));
      expect(component.blocks.length, 6);
      expect(component.blocks[0].type, 'heading');
      expect(component.blocks[0].text, 'ಪ್ರಾತಃ ಸಂಧ್ಯಾ ಸಂಕಲ್ಪ');
      ...
      expect(
        ...
        'ಮಮ ಉಪಾತ್ತ ಸಮಸ್ತ ದುರಿತಕ್ಷಯದ್ವಾರಾ ಶ್ರೀ ಪರಮೇಶ್ವರ ಪ್ರೀತ್ಯರ್ಥಂ ಪ್ರಾತಃ ಸಂಧ್ಯಾಂ ಉಪಾಸ್ಯೇ ॥',
      );
    });
  });
}

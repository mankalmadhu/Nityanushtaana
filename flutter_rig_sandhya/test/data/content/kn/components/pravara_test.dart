...
void main() {
  group('Data Layer - Kannada Content Sanitization', () {
    test('pravara content has not been accidentally modified', () {
      ...
      expect(component.blocks[0].text, 'ಚತುಸ್ಸಾಗರ ಪರ್ಯ೦ತ೦ ಗೋ ಬ್ರಾಹ್ಮಣೇಭ್ಯಃ ಶುಭ೦ ಭವತು ವೈಶ್ವಾಮಿತ್ರ ಅಘಮರ್ಷಣ ಕೌಶಿಕ ತ್ರಯಾರ್ಷೇಯ ಪ್ರವರಾನ್ವಿತ ಕೌಶಿಕ ಸಗೋತ್ರಃ ಆಶ್ವಲಾಯನ ಸೂತ್ರಃ ಋಕ್ ಶಾಖಾ ಅಧ್ಯಾಯಿ ಶ್ರೀ ತೇಜೋ __ ಶರ್ಮ ಅಹ೦ಭೋ ಅಭಿವಾದಯೇ ॥');
    });
  });
}

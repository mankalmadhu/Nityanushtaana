...
void main() {
  group('Data Layer - Kannada Ritual Sanitization', () {
    test('pratah_samidhadana ritual has not been accidentally modified', () {
      ...
      expect(ritual.pages[1].componentIds[0], 'pratah_samidha_dana_sankalpa');
      ...
      expect(ritual.pages[8].componentIds[1], 'pratah_samidha_dana_samarpana');
